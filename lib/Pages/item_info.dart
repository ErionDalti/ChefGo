...
class ItemInfoPage extends StatefulWidget {
  FoodItem foodItem;
  final updateExtra;
  final _updateFoodItems;
  final _updateFoodItemByIdAndAction;
  final __updateCartItemsCounter;
  ItemInfoPage(this.foodItem, this.updateExtra, this._updateFoodItems,
      this._updateFoodItemByIdAndAction, this.__updateCartItemsCounter);
  @override
...
class _ItemInfoPageState extends State<ItemInfoPage> {
  ...
  //   FoodItem('1', 'assets/food items/food1.jpg', 'Veg Sandwich', true, '5.00',
  //       false, 0, "", ""),
  //   FoodItem('2', 'assets/food items/food2.jpg', 'Shrips Rice', true, '3.00',
  //       false, 0, "", ""),
  //   FoodItem('3', 'assets/food items/food3.jpg', 'Cheese Bread', true, '4.00',
  //       false, 0, "", ""),
  //   FoodItem('4', 'assets/food items/food4.jpg', 'Veg Cheeswich', true, '3.50',
  //       false, 0, "", ""),
  //   FoodItem('5', 'assets/food items/food5.jpg', 'Margherita Pizza', true,
  //       '4.50', false, 0, "", ""),
  //   FoodItem('6', 'assets/food items/food6.jpg', 'Veg Manchau', true, '2.50',
  //       false, 0, "", ""),
  //   FoodItem('7', 'assets/food items/food7.jpg', 'Spring Noodle', true, '3.00',
  //       false, 0, "", ""),
  //   FoodItem('8', 'assets/food items/food8.jpg', 'Veg Mix Pizza', true, '5.00',
  //       false, 0, "", ""),
  // ];
  @override
                    ...
                    children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: (widget.foodItem.image == null ||
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Text(
                                  '\ALL ${this.widget.foodItem.price}',
                            ...
                            //   },
                            //   initialValue: this.widget.foodItem.extras,
                            //   decoration:
                      ...
                      GestureDetector(
                          onTap: () {
                            ...
                            widget._updateFoodItems();
                            widget.__updateCartItemsCounter(
                                widget.foodItem.itemId);

                            widget._updateFoodItemByIdAndAction(
                                this.widget.foodItem.itemId, "add");
                          },
                          child: Container(
                              height: 50,
                              decoration: BoxDecoration(
